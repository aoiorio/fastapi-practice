...
def test_create_access_token():
    ...
    # execute a function with fake(test) values
...
# I'm using asyncio to execute asynchronous function which is provided by pytest
@pytest.mark.asyncio
...
async def test_get_current_user_missing_payload():
    # this encode valuable is a collapsing value.
    encode = {'role': 'user'}
    token = jwt.encode(encode, SECRET_KEY, algorithm=ALGORITHM)
